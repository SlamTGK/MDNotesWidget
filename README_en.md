...
* 🎲 **Smart Randomization**: Periodically updates the widget with a random note. Built-in repetition protection ensures you see fresh content.
...
## 🛠️ Requirements
* **Android 12.0+ (API 31)** up to **Android 16+**.
